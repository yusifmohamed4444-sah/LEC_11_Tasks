...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BrandId).HasName("PK__brands__5E5A8E27DCC11263");
        });

        modelBuilder.Entity<Category>(entity =>
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__categori__D54EE9B433C0AFDA");
        });

        modelBuilder.Entity<Customer>(entity =>
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB85D7D45A98");
        });

        modelBuilder.Entity<Log>(entity =>
        {
            entity.HasKey(e => e.LogId).HasName("PK__logs__9E2397E01D4E5D65");
        ...
        {
            entity.HasKey(e => e.LogId).HasName("PK__logs__9E2397E08B6B86B8");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__465962293D2E3B27");

            entity.ToTable("orders", "sales", tb =>
                {
                    tb.HasTrigger("O_trigger");
                    tb.HasTrigger("logs_1");
                });
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ItemId }).HasName("PK__order_it__837942D477421B28");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__products__47027DF5D9BE2F07");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staffs__1963DD9C037E9359");
        ...
        {
            entity.HasKey(e => new { e.StoreId, e.ProductId }).HasName("PK__stocks__E68284D3580ED45C");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__stores__A2F2A30CBDDD4C4E");
        });
